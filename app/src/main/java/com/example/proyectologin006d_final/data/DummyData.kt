...
private val comunasPorRegion = mapOf(
    ...
    "Ñuble" to listOf("Chillán", "Bulnes", "Cobquecura", "Coelemu", "Coihueco", "Chillán Viejo", "El Carmen", "Ninhue", "Ñiquén", "Pemuco", "Pinto", "Portezuelo", "Quillón", "Quirihue", "Ránquil", "San Carlos", "San Fabián", "San Ignacio", "San Nicolás", "Treguaco", "Yungay"),
...
fun obtenerComunas(region: String): List<String> {
    return comunasPorRegion[region] ?: emptyList()
}
